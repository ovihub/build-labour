    ...
    <div class="profile-item-2">
        <div class="profile-content">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10">
                    <span class="employment-label">Richmond, Victoria, Australia</span>
                    <span class="employment-label">$1,750,000</span>
                    <span class="employment-label">Responsibilities:</span>
